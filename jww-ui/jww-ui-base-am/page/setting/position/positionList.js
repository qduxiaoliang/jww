layui.config({
    ...
    var tableIns = table.render({
        ...
        cols: [[
            ...
            {field: 'professionName', title: '所属行业', align: 'center'},
            {field: 'opt', title: '操作', fixed: 'right', width: 120, align: 'center', toolbar: '#toolBar'}
        ]],
        url: 'profession/queryPositionListPage',
        method: 'POST',
        request: {
        ...
        if (layEvent === 'del') { //删除
            ...
            var index = layui.layer.open({
                ...
                success: function (layero, index) {
                    setTimeout(function () {
                        layui.layer.tips('点击此处返回岗位列表', '.layui-layer-setwin .layui-layer-close', {
                            tips: 3
                        });
                    }, 500)
                }
